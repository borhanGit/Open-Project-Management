...
<head>
    ...
    <title>Sign In - OpenProject Laravel</title>
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-4">
                ...
                <div>
                    <div class="flex items-center justify-between mb-1">
                        <label for="password" class="block text-xs font-semibold uppercase text-slate-500">Password</label>
                    </div>
                ...
                <div class="flex items-center justify-between text-xs">
                    ...
                    <a href="{{ route('docs.show', 'index') }}" class="text-blue-600 dark:text-blue-400 hover:underline">
                        Read Docs &rarr;
                    </a>
                </div>
